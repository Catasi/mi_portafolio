...
export const proyectos = [
    {
        ...
        nombre: "AppMedik",
        objetivo: "Desarrollo JIVM una aplicación móvil pediátrica para la gestión de citas médicas y la dosificación de medicamentos.",
        herramientas: [
            { nombre: "IDE", herramienta: "Android Studio 2023.1.13", img: ruta + "android_studio.png"},
            { nombre: "Framework", herramienta: "Node.js v.18.16.0", img: ruta + "nodejs.png" },
            { nombre: "Base de Datos", herramienta: "MongoDB Atlas v.4.4.6", img: ruta + "mongodb.png" },
            { nombre: "Servidor", herramienta: "AWS EC2 v.2.0.1", img: ruta + "awsec2.png" }
        ],
    ...
    },
    {
        ...
        herramientas: [
            ...
            { nombre: "Cliente API", herramienta: "Postman v.11.31.4", img: ruta + "postman.png" },
            { nombre: "IDE Alternativa", herramienta: "IntelliJIDEA 2024.2.5", img: ruta + "intellij.png" }
        ],
    ...
    },
    {
        ...
        herramientas: [
            { nombre: "Microcontrolador", herramienta: "Arduino Uno", img: ruta + "arduino.png" },
            { nombre: "IDE", herramienta: "Arduino IDE 2.3.4", img: ruta + "arduino.png" },
            { nombre: "IDE", herramienta: "Apache NetBeans IDE 24", img: ruta + "netbeans.png" },
            { nombre: "Servicio IoT", herramienta: "Dweet.io", img: ruta + "dweet.png"}
        ],
    ...
    },
    {
        ...
        herramientas: [
            ...
            { nombre: "Base de Datos", herramienta: "SQLite 2.4.0", img: ruta + "sqlite.png" }
        ],
